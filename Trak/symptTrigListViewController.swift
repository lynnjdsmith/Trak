...
protocol stlDelegate {
    //func didPressDate(val: NSString)
}

class symptTrigListViewController: UIViewController {

  var delegate: stlDelegate?  // The delegate that the parent view controller will conform to
